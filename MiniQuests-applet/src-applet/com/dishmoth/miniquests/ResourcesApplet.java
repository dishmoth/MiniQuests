...
public class ResourcesApplet implements Resources {

  // path for files (they're all in the root directory at present)
  static protected final String kRootPackageName = "";
  
  // constructor
  public ResourcesApplet() {
  ...
  public InputStream openResourceStream(String fileName) {
    ...
    try {
      ...
      URL url = ResourcesApplet.class.getClassLoader().getResource(resourceName);
